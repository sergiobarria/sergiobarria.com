...
2. [Install Sanity CLI](#install-sanity-cli)
3. [Create Next.js Project](#create-nextjs-project)
4. [Start Sanity Studio](#start-sanity-studio)
5. [Connect Sanity and Next Js](#connect-sanity-and-next-js)
   1. [Next to Sanity Connection](#next-to-sanity-connection)
   2. [Sanity to Next Connection](#sanity-to-next-connection)
6. [Fetch data from Sanity](#fetch-data-from-sanity)
   1. [Fetching Data Using GROQ](#fetching-data-using-groq)
7. [Render our data](#render-our-data)
8. [Finish our blog and deploy](#finish-our-blog-and-deploy)
   1. [Deploy frontend](#deploy-frontend)
   2. [Deploy Sanity Studio](#deploy-sanity-studio)
