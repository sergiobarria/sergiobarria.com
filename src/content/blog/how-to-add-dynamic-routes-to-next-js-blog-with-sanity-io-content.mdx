...
1. [Create a template for your routes](#create-a-template-for-your-routes)
2. [Fetching data from Sanity Studio](#fetching-data-from-sanity-studio)
...
5. [Pass the fetched data to our template](#pass-the-fetched-data-to-our-template)
6. [Incremental Static Regeneration](#incremental-static-regeneration)
