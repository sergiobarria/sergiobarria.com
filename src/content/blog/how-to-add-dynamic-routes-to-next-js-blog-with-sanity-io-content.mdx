...
1. [1. Create a template for your routes](#1-create-a-template-for-your-routes)
2. [2. Fetching data from Sanity Studio](#2-fetching-data-from-sanity-studio)
3. [Generate dynamic routes: `getStaticPaths`](#generate-dynamic-routesgetstaticpaths)
4. [Get static content: `getStaticProps`](#get-static-contentgetstaticprops)
5. [3. Pass the fetched data to our template](#3-pass-the-fetched-data-to-our-template)
6. [4. Incremental Static Regeneration](#4-incremental-static-regeneration)
7. [That's it!](#thats-it)
