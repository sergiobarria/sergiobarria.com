      ...
      <Container>
        ...
        <div className="relative w-full mb-4">
          <input
            ...
            className="block w-full px-4 py-2 text-gray-600 bg-white border border-gray-300 rounded-md outline-none dark:border-gray-900 focus:ring-orange-400 focus:border-orange-400 focus:ring-1 dark:bg-gray-800 dark:text-gray-100"
          />
          <svg
