...
excerpt: 'A very common question. We evaluated the pros and cons of learning one or more programming languages at the same time.'
image: 'static/images/should-i-learn-more-than-one-programming-language-at-the-same-time/should-i-learn-more-than-one-programming-language-at-the-same-time.jpg'
imageAuthor:
  'Photo by <a href="https://www.pexels.com/@thisisengineering?utm_content=attributionCopyText&utm_medium=referral&utm_source=pexels">ThisIsEngineering</a> on <a href="https://www.pexels.com/photo/code-projected-over-woman-3861969/?utm_content=attributionCopyText&utm_medium=referral&utm_source=pexels">Pexels</a>
  '
---
...
As I said in that post, been a developer is not easy, that's the sad truth. And that's precisely why you should really ask yourself many questions that help you with defining what path you want to follow and that will dictated how should you structure your study sessions.
...
You have to understand, this is normal. We all go through those phases. We all have doubts (many of which will accompany us for the rest of our career), the important thing is to keep focus on our goals. Because it is our goals that will help us to keep pushing.
...
This is more common than you think and if you're reading this you may be having this question in mind. The good news is that this article may help clarify some of this doubts. So let's examine both scenarios and see which are the pros and cons of each one and which is the better option.
...
So naturally (been so naive), I went full crazy mode on. I started learning everything I could: HTML, CSS, JavaScript, Python, Java...if it was related to programming I started learning it. After a few weeks of this "intense learning", you could imagine my results, I was exhausted!!! And even worst, I felt like I had learn basically nothing.

Now, by telling you this, I'm not implying that learning more than one programming language at the same time is necessarily bad. I'm telling you this in the hope that if you're considering to do the same as I did, you can learn from my mistake or at the very least you will think it twice.

Learning more than one language at the same time is not bad, IF done right. Obviously, my initial approach wasn't the right one. So, now let's really take a look to all the pros and cons of learning more than one programming language.

### Pro: You will keep your brain engaged with learning

There are studies out there that suggest that every time you learn a new skill, you're exercising your brain. With that in mind, by learning more languages at the same time you are exercising your brain and making it to keep up with learning pace.

Let's say by example that you start learning both Java and Python at the same time. One benefit you could get from this is that if you have a balanced and organized learning schedule, you can improve your learning because you are training your brain to apply some sort of "switch" that allow you to remember and alternate between languages, syntaxes and rules.
...
Also, by been learning two programming languages at the same time you can even alternate. If you start feeling exhausted or stuck with one language, you can put it on hold for a while, take a break and meanwhile could go and keep learning from the other language.
...
### Con: You can experience burn out
...
By learning one language, you're putting 100% of your attention to that language. This could be huge because it will allow you to go more in depth regarding not just that language but programming in general. Remember, programming is way more than just a language, it involves a lot more disciplines, tools and knowledge.
...
So, as I mentioned in the last point. By focusing on one language, you can easily develop a better foundation. This can later make way easier the process of learning more languages.
...
Let's say for example that you started learning Java, you invest X amount of time learning Java because you want to build something around its ecosystem, but after awhile you start to feel bored because even though you have a good Java foundation you still don't feel ready or don't know all the required tools for your project. So, because you don't see any real progress or you start to feel stuck, there is a considerable possibility of you abandoning the project and quit learning programming in general.

Again, this may not apply for everybody. But in my case, I started feeling bored after a while of learning JavaScript. It's not that I don't like the language, I do (as weird and frustrating as it can be sometimes). It's just that I can't just be involved in just one thing for too long. In my case I fixed this by taking a break from learning JavaScript and started learning Python. Of course after a while, I retaked JavaScript and felt more motivated to keep going.

This is the reason on why many senior developers recommend to have at least two side projects. That way if you get tired of project A, can go and work on project B. And if you get tired (or stuck) with project B, you can go back to project A.

## Final thoughts...

Ok so, which route should you follow? The answer is really easy (and you may not like it). **It all depends on you.**

_Do you enjoy focusing on one thing and can spend a lot of time learning all the bells and whistles of something?_, then go with one language and become an expert on it. Once you finish, you can move to the next language if you like it. This can also help you to build a better foundations and structure not just of that language you picked but of programming in general.

On the other hand, _if you're someone like me and can't just focus on one thing for too long without getting bored or tired_, then my suggestion would be to pick two languages. One which would be your "main language" and then have a second language (a back-up) in which you can alternate and enjoy more the learning process. I don't suggest you to go for more than two languages because as I have said before, it can easily become a nightmare. This route may take you a bit longer, but at the end of the day, this is a marathon, not a sprint.
