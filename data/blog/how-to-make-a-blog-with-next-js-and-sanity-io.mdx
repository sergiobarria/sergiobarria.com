...
image: '/static/images/blog/how-to-make-a-blog-with-next-js-and-sanity-io/main-image.png'
---
...
If the output shows some version of node like: **_"v14.15.5"_** or similar, your good to go. If not, it means you have to install node in your computer. Just go to this [link](https://nodejs.org/en/) and install the LTS version.
...
<Image
  src="/static/images/blog/how-to-make-a-blog-with-next-js-and-sanity-io/sanity-studio-local-server.png"
  width={818}
  height={295}
  priority
/>
...
<Image
  src="/static/images/blog/how-to-make-a-blog-with-next-js-and-sanity-io/sanity-project-id.png"
  width={2138}
  height={776}
  priority
/>
...
<Image
  src="/static/images/blog/how-to-make-a-blog-with-next-js-and-sanity-io/add-local-server.png"
  width={1140}
  height={471}
  priority
/>
...
<Image
  src="/static/images/blog/how-to-make-a-blog-with-next-js-and-sanity-io/adding-url.png"
  width={975}
  height={348}
  priority
/>
...
<Image
  src="/static/images/blog/how-to-make-a-blog-with-next-js-and-sanity-io/create-new-post.png"
  width={1918}
  height={426}
  priority
/>
...
Our `GROQ` query will be the one inside the back ticks of the fetch function.
