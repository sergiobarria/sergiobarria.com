...
summary: Let's see how to build an API using Python's framework FastAPI. This is part 2 of a series of posts where we build an API for a fictional book store.
image:
isFeatured: false
isArchived: false
keywords:
...
In the last post we created a base setup for our project. In case you didn't read it, or want to check it, here is the [link](/blog/fastapi-tutorial-part-1-the-basics).
...
<Image
    ...
    src="/images/posts/16/api-title-description.png"
    width={524}
    height={148}
/>
...
<Image
    ...
    src="/images/posts/16/endpoint-with-query-params.png"
    width={1442}
    height={564}
/>
...
<Image
    ...
    src="/images/posts/16/endpoint-with-query-params-response.png"
    width={1425}
    height={561}
/>
...
<Image
    alt="endpoint with query params response"
    src="/images/posts/16/api-books-authors-routes.png"
    width={1439}
    height={918}
/>
